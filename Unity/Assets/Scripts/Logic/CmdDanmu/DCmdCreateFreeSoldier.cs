...
[CDanmuCmdAttrite(CDanmuEventConst.CreateSoldier)]
public class DCmdCreateFreeSoldier : CDanmuCmdAction
{
    ...
    void CreateUnitLocal(CPlayerBaseInfo player)
    {
        //还未选阵营
