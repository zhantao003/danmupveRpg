...
namespace DouyinDanmu
{
    public class DMsgSimulater : MonoBehaviour
    {
        ...
        public void SendDanmu()
        {
            ...
            StartCoroutine(RequestWebUTF8(szUrl + "/api/ttdanmu", "POST", szParam, null, null, delegate (string value)
            {
                Debug.Log("回馈：" + value);
            }));
        }
        ...
        public void SendGift()
        {
            ...
            StartCoroutine(RequestWebUTF8(szUrl + "/api/ttgift", "POST", szParam, null, null, delegate (string value)
            {
                Debug.Log("回馈：" + value);
            }));
        }
        ...
        public void SendLike()
        {
            ...
            StartCoroutine(RequestWebUTF8(szUrl + "/api/ttdz", "POST", szParam, null, null, delegate (string value)
            {
                Debug.Log("回馈：" + value);
            }));
        }
        ...
        void OnConnectSuc()
        {
            ...
            string szParam = $"{{\"uid\":\"{CDanmuSDKCenter.Ins.szUid}\"," +
                             $"\"roomId\":\"{CDanmuSDKCenter.Ins.szUid}\"," +
                             $"\"cmd\":\"login\"," +
                             $"\"content\":\"n\"}}";
        ...
        IEnumerator RequestWebUTF8(string url, string method, string param, Dictionary<string, string> dicHeader, string cookie, System.Action<string> handler = null)
        {
            ...
            webRequest.SetRequestHeader("x-roomid", CDanmuSDKCenter.Ins.szUid);
